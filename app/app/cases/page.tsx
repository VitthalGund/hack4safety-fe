...
export default function CasesPage() {
  ...
  const {
    ...
    "/api/cases/search",
    () => apiService.searchCases({ query: searchTerm, limit: 50 }),
    {
  ...
  const filteredCases =
    filterStatus === "all"
      ? cases
      : cases.filter((c: Case) => c.status === filterStatus);
    ...
    <div className="space-y-8 p-3">
      ...
      <div className="space-y-4">
        ...
        <p className="text-muted-foreground">
          Search and manage all cases in the system
        </p>
      </div>
              ...
              {isLoading ? (
                <div className="space-y-3">
                  {[1, 2, 3].map((i) => (
                    <div
                      key={i}
                      className="h-24 bg-muted rounded-lg animate-pulse dark:bg-muted"
                    />
                  ))}
                </div>
                      ...
                      <CardContent className="p-4">
                        <div className="flex justify-between items-start">
                          ...
                          <div className="flex flex-col items-end gap-3">
                            ...
                            >
                              {/* --- FIX: Added safety check for status --- */}
                              {caseItem.status
